  ...
  useEffect(() => {
    ...
    async function run() {
      try {
        ...
        if (!qz.topicIds.length) throw new Error("Quiz has no topics configured");
        ...
        const perChunkLimit = Math.max(want, Math.ceil(want / topicChunks.length));
        ...
        if (!finalQs.length) throw new Error("No active questions found for this quiz");
  ...
  if (err) {
    return (
      <div className="page">
        <div className="container">
          <section className="card">
            <div style={{ fontWeight: 900, fontSize: 18 }}>Cannot start quiz</div>
    ...
    <div className="page">
      <div className="container">
        <div className="spaceBetween">
          <div>
            <div className="muted" style={{ fontSize: 12 }}>{quiz.name || "Quiz"}</div>
          ...
          <div style={{ textAlign: "right" }}>
            <div className="muted" style={{ fontSize: 12 }}>Time left</div>
        ...
        <div className="spaceBetween muted" style={{ marginTop: 12, fontSize: 13 }}>
          <div>
          ...
          {showExplanation && (
            <div
              style={{
                ...
                borderRadius: 12,
                background:
                  selected == null ? "#fff7ed" : isCorrect ? "#f0fdf4" : "#fef2f2",
                border: `1px solid ${
                  selected == null ? "#fed7aa" : isCorrect ? "#bbf7d0" : "#fecaca"
                }`,
              }}
            >
              ...
              <div style={{ marginTop: 14 }}>
                <button className="btn btnPrimary" onClick={next} disabled={finishing}>
                  {idx < questions.length - 1 ? "Continue →" : finishing ? "Saving…" : "Finish Quiz"}
                </button>
              </div>
            </div>
          )}
        ...
        <div className="row" style={{ marginTop: 16, justifyContent: "space-between" }}>
          <Link className="btn btnGhost" to="/">Exit</Link>
